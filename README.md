...
Supabase Auth·Database·Storage와 OpenAI API를 사용하는 도서관 웹서비스입니다.
...
`supabase/migrations`의 SQL을 Supabase SQL Editor에서 실행합니다. 도서 표지 파일 업로드에는 `20260722_book_cover_storage.sql`이 필요합니다.
...
ISBN은 AI가 생성하지 않습니다. 입력값을 사용하거나 Google Books에서 제목·저자가 일치하는 결과가 확인될 때만 자동 입력합니다.
